...
<body class="dashboard-page">
	...
	<nav class="main-menu">
		<ul>
			...
			<li class="has-subnav"><a href="AddMuncipalcorporation.jsp"> <i
					class="fa fa-check-square-o nav_icon"></i> <span class="nav-text">
						Add Muncipal corporation </span></li>

			<li><a href="ViewMuncipalcorporation.jsp"> <i class="icon-table nav-icon"></i>
					<span class="nav-text">Muncipal corporation Data</span>
			</a></li>
	...
	<section class="wrapper scrollable">
		...
		<section class="title-bar">
			<div class="logo">
				<h3>
					<a href="index.html"><img src="images/logo.png" alt="" /> Admin Panel </a>
				</h3>
			</div>
		</section>
			<div class="main-grid">
				<div class="agile-grids">
					<div class="agile-tables">
						<div class="w3l-table-info">
							<font color="red"><h2>     Welcome in EchoAlert System</h2></font></div></div></div></div>
	</section>
