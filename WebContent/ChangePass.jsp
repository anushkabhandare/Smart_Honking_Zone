...
<body class="dashboard-page">
	...
	<%
									...
									String cid = UserInfo.getId();
								%>
								<%
									try {
										Connection conn = DBconnect.getConnect();
										statement = conn.createStatement();
										String sql = "select * from corporation where id = '"+cid+"'";
	...
	<section class="wrapper scrollable">
	<form class="form-horizontal" action="update_process_pass.jsp?id=<%=resultSet.getString("id")%>" method="post">
		<nav class="user-menu">
			<a href="javascript:;" class="main-menu-access"> <i
				class="icon-proton-logo"></i> <i class="icon-reorder"></i>
			</a>
			...
			<div class="main-grid">
				<div class="panel panel-widget forms-panel">
					<div class="progressbar-heading general-heading">
						<h4>Update Corporation Password</h4>
					</div>
					<div class="forms">
						<h3 class="title1"></h3>
						<div class="form-three widget-shadow">
								<div class="form-group">
									...
									<%-- <div class="col-sm-8">
										...
										name="oldTxt"
										value="<%=resultSet.getString("pass")%>" disabled="disabled">
									</div> --%>
									
									<div class="col-sm-8">
										<input type="text" cols="7" rows="1" class="form-control"
										name="oldTxt" placeholder = "Enter Current Password">
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="col-sm-8">
											<input type="text" cols="7" rows="1" class="form-control"
											name="newpassTxt" placeholder = "Enter New Password" minlength="4">
										</div>
									</div>
